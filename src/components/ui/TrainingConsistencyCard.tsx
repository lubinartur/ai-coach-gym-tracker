      ...
      <Card className="!p-5">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-3xl font-semibold tabular-nums text-neutral-50">
              {score}
              <span className="ml-0.5 text-lg font-medium text-neutral-500">/100</span>
            </p>
            <p className="mt-1.5 text-sm text-violet-300/90">
              {t(statusKey(status))}
            </p>
          </div>
        </div>
        <dl className="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <div className="rounded-xl border border-neutral-800/80 bg-neutral-950/30 px-3 py-2.5 sm:col-span-2">
            <dt className="text-[11px] font-medium uppercase tracking-wide text-neutral-500">
